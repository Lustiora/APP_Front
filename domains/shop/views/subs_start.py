...
def subs_options(page: ft.Page, popup):
    ...
    add_subs_option = dogdog.content_container(
        content_list=[
            dogdog.basic_text("AI 자동배송 선택", weight="bold", color=ft.Colors.GREY_800),
            ft.Row(alignment=ft.MainAxisAlignment.CENTER, controls=[
                dogdog.radio_group(
